      ...
      <div className="features-section">
        ...
        <div className="card-row">
          ...
          <div className="flip-card">
            <div className="flip-card-inner">
              <div className="flip-card-front">
                <img src={therapyImg} alt="AI Therapy" className="feature-img" />
          ...
          <div className="flip-card">
            <div className="flip-card-inner">
              <div className="flip-card-front">
                <img src={cbtImg} alt="Cognitive Behavioral Therapy" className="feature-img" />
          ...
          <div className="flip-card">
            <div className="flip-card-inner">
              <div className="flip-card-front">
                <img src={moodImg} alt="Mood Tracking" className="feature-img" />
          ...
          <div className="flip-card">
            <div className="flip-card-inner">
              <div className="flip-card-front">
                <img src={supportImg} alt="Support Group" className="feature-img" />
