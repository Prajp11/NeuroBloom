      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/stress-relief/cbt">CBT Exercises</Link></li>
            <li><Link to="/stress-relief/education">Mental Health Education</Link></li>
            <li><Link to="/stress-relief/games">Wellness Games</Link></li>
          </ul>
        </div>
